...
phases = [
    ("1", "CI green", "active", "running", "4 fix steps applied; monitoring first run on new workflow"),
    ("2", "CMake-level strip build", "active", "running", "10 WITH_* flags already set in CI"),
    ("3", "Source-level strip (sculpt/animation)", "todo", "planned", "after first green build"),
    ("4", "GTA pipeline: DFF/TXD + KAM-style tooling", "todo", "planned", "native port of KAM scripts"),
    ("5", "UI pruning for texture-paint focus", "todo", "planned", ""),
]
...
<p>Lightweight Blender 2.83 LTS fork — GTA SA / MTA SA texture painting &amp; UV skinning</p>
</header>
<main>
...
{section("Strip list — phase 1 (CMake flags, in CI now)", md_table(phase1))}
<div class="grid">
{section("Strip list — phase 2 (after green build)", md_table(phase2))}
{section("Keep (core of Vibe3D)", f'<p>{inline(keeps.strip())}</p>')}
</div>
